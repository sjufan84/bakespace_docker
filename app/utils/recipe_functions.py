...
# Set up the client
client = OpenAI(api_key=api_key, organization=organization, max_retries=3, timeout=9)
    ...
    messages = [
        {
            "role": "system", "content": f"""You are a master chef helping a user
                ...
                Do your best to return the recipe as a JSON object with the same
                schema as the Recipe model.  Return only the recipe object.""",
        },
    ]
...
def adjust_recipe(recipe: str, adjustments: str):
