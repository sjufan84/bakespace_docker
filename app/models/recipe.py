...
class Recipe(BaseModel):
    ...
    ingredients: Union[str, List[str]] = Field(description="The ingredients for the recipe.")
    directions: Union[str, List[str]] = Field(description="The directions for\
    ...
    calories: int = Field(description="The number of calories in the recipe.")
