...
**Recipe Text Extraction**: Users can upload recipes in various formats,
including PDF, Word doc, text file, or an
image of a handwritten recipe. These recipes are formatted
and can be saved, discussed, or included in cookbooks.

**Image Generation**: Integration with OpenAI's Dall-e-2
image generation API allows for recipe-based image prompts,
...
# Include routers
routers = [chat_routes, image_routes, extraction_routes]
