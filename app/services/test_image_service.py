...
class TestImageService(unittest.TestCase):
    ...
    @patch('image_service.OpenAI')
    def test_get_image_prompt(self, mock_openai):
        # Arrange
        ...
        # Act
        result = get_image_prompt(recipe)
